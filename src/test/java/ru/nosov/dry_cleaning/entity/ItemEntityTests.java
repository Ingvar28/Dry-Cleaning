...
public class ItemEntityTests {
    ...
    public void testCreateOrder() throws Exception {
        String uri = "/item";
        OrderInDTO dto = objectMapper.convertValue(itemRepository.findById(dataInitializer.orderEntity.getId()), OrderInDTO.class);
    ...
    public void testDelete() throws Exception {
        ...
        Assert.assertTrue("There was not such entity to remove!", itemRepository.existsById(idToDelete));
        mockMvc.perform(delete(uri, idToDelete).contentType(MediaType.APPLICATION_JSON))
                .andDo(document(uri.replace("/", "\\")))
                .andExpect(status().isOk());
        Assert.assertFalse("The entity was not removed!", itemRepository.existsById(idToDelete));
    }
