...
public class PositionEnityTest {
    MockMvc mockMvc;
    ...
    public void testCreateOrder() throws Exception {
        String uri = "/position";
        OrderInDTO dto = objectMapper.convertValue(positionRepository.findById(dataInitializer.orderEntity.getId()), OrderInDTO.class);
    ...
    public void testDelete() throws Exception {
        ...
        Assert.assertTrue("There was not such entity to remove!", positionRepository.existsById(idToDelete));
        mockMvc.perform(delete(uri, idToDelete).contentType(MediaType.APPLICATION_JSON))
                .andDo(document(uri.replace("/", "\\")))
                .andExpect(status().isOk());
        Assert.assertFalse("The entity was not removed!", positionRepository.existsById(idToDelete));
    }
