...
public class ServiceTypeEnityTest {
    MockMvc mockMvc;
    ...
    public void testCreateOrder() throws Exception {
        ...
        OrderInDTO dto = objectMapper.convertValue(serviceTypeRepository.findById(dataInitializer.orderEntity.getId()), OrderInDTO.class);
    ...
    public void testDelete() throws Exception {
        ...
        Assert.assertTrue("There was not such entity to remove!", serviceTypeRepository.existsById(idToDelete));
        mockMvc.perform(delete(uri, idToDelete).contentType(MediaType.APPLICATION_JSON))
                .andDo(document(uri.replace("/", "\\")))
                .andExpect(status().isOk());
        Assert.assertFalse("The entity was not removed!", serviceTypeRepository.existsById(idToDelete));
    }
