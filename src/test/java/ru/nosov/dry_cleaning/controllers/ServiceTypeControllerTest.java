...
public class ServiceTypeControllerTest {
    ...
    public void getAll() throws Exception {
        this.mockMvc.perform(get(URL_PREFIX))
                .andExpect(status().isOk())
                .andExpect(jsonPath("servicetype")
                        .value(Matchers.contains(dataInitializer.getServiceTypeEntity().getServiceType())));
    }
    ...
    public void create() throws Exception {
        this.mockMvc.perform(post(URL_PREFIX).contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("servicetype", is(validDTO.getServiceTypeInDTO().getServiceType())));
    }
    ...
    public void update() throws Exception {
        this.mockMvc.perform(put(URL_PREFIX)
                        .contentType(MediaType.APPLICATION_JSON).content(objectMapper.
                                writeValueAsString(validDTO.getServiceTypeInDTO())))
                .andExpect(status().isOk());
