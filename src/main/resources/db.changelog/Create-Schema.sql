CREATE SCHEMA if not exists dry_cleaning;

CREATE TABLE dry_cleaning.client
(
...
CREATE TABLE dry_cleaning.clothes_category
(
    id          BIGINT AUTO_INCREMENT NOT NULL,
    create_date datetime              NULL,
    active      BIT(1)                NOT NULL,
...
CREATE TABLE dry_cleaning.position
(
    id          BIGINT AUTO_INCREMENT NOT NULL,
    create_date datetime              NULL,
    active      BIT(1)                NOT NULL,
...
CREATE TABLE dry_cleaning.service_type
(
    id           BIGINT AUTO_INCREMENT NOT NULL,
    create_date  datetime              NULL,
    active       BIT(1)                NOT NULL,
...
CREATE TABLE dry_cleaning.payment
(
    id             BIGINT AUTO_INCREMENT NOT NULL,
    create_date    datetime              NULL,
    active         BIT(1)                NOT NULL,
...
CREATE TABLE dry_cleaning.order_cart
(
    id               BIGINT AUTO_INCREMENT NOT NULL,
    create_date      datetime              NULL,
    active           BIT(1)                NOT NULL,
...
CREATE TABLE dry_cleaning.cart_item
(
    id                  BIGINT AUTO_INCREMENT NOT NULL,
    create_date         datetime              NULL,
    active              BIT(1)                NOT NULL,
...
ALTER TABLE dry_cleaning.cart_item
    ADD CONSTRAINT FK_CART_ITEM_ON_ORDER_CART FOREIGN KEY (order_cart_id) REFERENCES dry_cleaning.order_cart (id);
